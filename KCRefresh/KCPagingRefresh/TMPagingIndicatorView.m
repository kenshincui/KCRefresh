...
#define kTMPagingIndicatorViewAnimationKey @"TMPagingIndicatorViewRotateAnimationKey"

@interface TMPagingIndicatorView()
@property (strong,nonatomic) CAShapeLayer *shapeLayer;
@property (strong,nonatomic) CABasicAnimation *rotateAnimation;
@end

@implementation TMPagingIndicatorView
...
-(void)startRotate{
    [self endRotate];
    [self.shapeLayer addAnimation:self.rotateAnimation forKey:kTMPagingIndicatorViewAnimationKey];
}

-(void)endRotate{
    if ([self.shapeLayer animationForKey:kTMPagingIndicatorViewAnimationKey]) {
        [self.shapeLayer removeAnimationForKey:kTMPagingIndicatorViewAnimationKey];
    }
}
