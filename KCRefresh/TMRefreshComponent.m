...
#import "TMRefreshComponent.h"

@interface TMRefreshComponent()
//UIScrollView手势，避免UIScrollView被释放后移除KVO报错
@property (strong,nonatomic) UIPanGestureRecognizer *panGestureRecognizer;
@end

@implementation TMRefreshComponent
...
#pragma mark - 属性
-(void)setRefreshState:(TMRefreshState)refreshState{
...
#pragma mark - 公共方法
-(void)endRefreshing{
    self.refreshState=TMRefreshStateIdle;
}
